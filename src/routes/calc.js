    ...
    <div style={{margin: "1em"}}>
      ...
      <div style={{display: "flex", flexDirection: "column"}}>
        ...
        <input className="text-input" value={inputRez} type="text" onChange={e => setInputRez(e.target.value)}/>
          ...
          <input className="text-input" value={inputImz} type="text" onChange={e => setInputImz(e.target.value)}/>
          <span style={{fontSize: "1.6em", marginLeft: "-20px"}}>i</span>
        </div>
        ...
        </div>
        {
          ...
          (<button style={{marginTop: "1em"}} className="fancy-button" onClick={obliczanie}>Oblicz</button>)
    ...
    <>
      ...
      <div style={{display: "flex", flexDirection: "column"}}>
        <div style={{marginBottom: 0, borderLeft: "2px solid var(--text3)", borderRight: "2px solid var(--text3)"}} className="calc-container-1">
          <div style={{position: "relative"}} className="calc-container-1">
            ...
            <span style={{fontSize: "1.2em", position: "absolute", right: "40px"}}>j</span>
          </div>
          <div style={{position: "relative"}} className="calc-container-1">
        ...
        <div style={{marginTop: 0, borderLeft: "2px solid var(--text3)", borderRight: "2px solid var(--text3)"}} className="calc-container-1">
          ...
          <div style={{position: "relative"}} className="calc-container-1">
            ...
            <span style={{fontSize: "1.6em", marginRight: "0px"}}>+</span>
            <input className="text-input" type="text" value={d[1]} onChange={e => setD([d[1], e.target.value])}/>
            <span style={{fontSize: "1.2em", position: "absolute", right: "40px"}}>j</span>
          </div>
        </div>
